...
storiesOf("InterviewerList", module)
  ...
  storiesOf("Appointment", module)
    ...
    .add("Empty", () => <Empty onAdd={action("onAdd")} />)   // for onClick event handler
    ...
    .add("Edit", () => <Form student={"Rita V"} interviewer={1} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
